...
public class MainActivity extends AppCompatActivity {
    ...
    Thread thread;
    Handler handler;
    Map<String,Object> messageContext=null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chatClass.setMessage("Hi !, Welcome to the Pizza World, May I take your order?");
        chatClass.setPos(1);
    ...
    class MyThread implements Runnable{
        ...
        public void run() {
            ...
            try {
                ...
                messageContext = response.getContext();
                ...
                {
                    Log.d("Json Array",jsonArray.getString(i));
